    ...
    <div class="app-container container-fluid d-flex align-items-stretch justify-content-between"
        ...
        <div class="d-flex align-items-center flex-grow-1 flex-lg-grow-0">
            <a href="index.html" class="d-lg-none">
                <img alt="Logo" src="assets/img/illustrations/lsp_polinema.jpeg" class="theme-light-show h-30px" />
                <img alt="Logo" src="assets/img/illustrations/lsp_polinema.jpeg" class="theme-dark-show h-30px" />
            </a>
        </div>
        <!--end::Mobile logo-->
